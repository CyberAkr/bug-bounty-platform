...
public class FileStorageService {
    ...
    @Value("${app.upload.max-bytes:5242880}") // 5MB
    ...
    public String storeProfilePhoto(MultipartFile file) throws IOException {
        ...
        Path targetDir = Paths.get(baseUploadDir, profileSubDir).toAbsolutePath().normalize();
        ...
        // URL publique servie par WebConfig: /files/profile/{filename}
        return "/files/" + profileSubDir + "/" + filename;
    }
}
